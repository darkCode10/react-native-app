...
export default function ClientProfileScreen({ }: Props) {
    ...
    const uploadProfilePicture = useMutation({
        mutationFn: async (params: { fileUri: string; fileName: string }) => {
            // Create a file-like object from the URI for React Native
            const file = {
                uri: params.fileUri,
                name: params.fileName,
                type: 'image/jpeg',
            };
            return await updateClientProfileImage({
        ...
        onSuccess: (newProfilePicUrl) => {
            ...
            queryClient.invalidateQueries({ queryKey: ['clientProfile', user?.userId] });
                ...
                <View style={styles.profileHeaderContent}>
                    ...
                    <View style={styles.headerInfo}>
                        ...
                        <View style={styles.roleBadge}>
                            <Ionicons name="briefcase-outline" size={14} color="#E0E7FF" />
