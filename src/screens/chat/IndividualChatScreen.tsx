...
export default function IndividualChatScreen({ route, navigation }: Props) {
    ...
    }, [navigation, otherUserName, otherUserProfilePic, user?.role, handleBackPress]);
    ...
    const renderMessage = ({ item, index }: { item: any; index: number }) => {
        ...
        let isLastInSequence = !nextMessage || nextMessage.sender_role !== item.sender_role;
        ...
        let isFirstInSequence = !prevMessage || prevMessage.sender_role !== item.sender_role;
                ...
                >
                    ...
                    {isFirstInSequence && (
                        <Text
                            ...
                            ellipsizeMode="tail"
                        >
                            {isMyMessage ? user?.username : otherUserName}
                        </Text>
                    )}
